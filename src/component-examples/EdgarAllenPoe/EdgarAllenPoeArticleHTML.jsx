        ...
        <article>
          ...
          <section>
            ...
            <p>
              ...
              assumed name,
              <s>Edward J. Crumplestiltskin</s> (this has been debunked, see
              <sup>3</sup>)
            </p>
          </section>
          <aside>
          ...
          <section>
            ...
            <section>
              <h4>
                <cite>&ldquo;The Raven&rdquo;</cite>
              </h4>
              <p>
                Poe&rsquo;s most famous work is{" "}
                <cite>&ldquo;The Raven&rdquo;</cite>. Here is the first stanza:
              </p>
              <blockquote cite="https://www.poetryfoundation.org/poems/48860/the-raven">
            ...
            <section>
              ...
              <table>
                ...
                <tbody>
                  <tr>
                    <td>
                      <cite>&ldquo;The Black Cat&rdquo;</cite>
                    </td>
                    <td>Story</td>
                  </tr>
                  <tr>
                    <td>
                      <cite>&ldquo;The Cask of Amontillado&rdquo;</cite>
                    </td>
                    <td>Story</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td>
                      <cite>&ldquo;Annabel Lee&rdquo;</cite>
                    </td>
                    <td>Poem</td>
                  </tr>
                  <tr>
                    <td>
                      <cite>&ldquo;The Bells&rdquo;</cite>
                    </td>
                    <td>Poem</td>
                  </tr>
                  <tr>
                    <td>
                      <cite>&ldquo;Lenore&rdquo;</cite>
                    </td>
                    <td>Poem</td>
                  </tr>
                  <tr>
          ...
          <section>
            ...
            <p>
              ...
              the name <q>Reynolds</q> on the night before his death, though it
              is unclear to whom he was referring. Some sources say that
      ...
      <footer>
        ...
        <ul>
          ...
          <li id="cite-4">
            ...
            <cite>&ldquo;Poe&rsquo;s Literary Labors and Rewards&rdquo;</cite>.
          ...
          <li id="cite-6">
            ...
            <cite>&ldquo;Edgar Allan Poe Cottage&rdquo;</cite>. Archived from
            the original on October 11, 2007. Archived from the original on
            2007-10-11.
          </li>
          <li id="cite-7">
        ...
        <small>&copy; April Bingham</small>
        <small>&trade; April Bingham</small>
      </footer>
    </div>
  );
};
